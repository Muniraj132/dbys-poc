                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">you can update your password</p>
                                    </div>

                                    <form method="POST" id="registerform" action="{{ route('password.update') }}" class="row g-3">
                                        @csrf
                                ...
                                @enderror   
                                     ...
                                     <div class="col-12">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <br><br>
                                        <div class="col-12">
                                            <button class="btn btn-primary w-100 btn-color" type="submit">Submit</button>
                                        </div>
                                        <div class="col-12">
